...
export const STICKERS = [
  {
    ...
    action: 'His WHOLE BODY bounces up and down on his feet with the beat, head bobbing, torso twisting side to side, head and shoulders swinging with the motion, thumb pumping. Everything moves together — head, body, arms, legs',
  },
  {
    slug: 'gm', src: '01-hero-portrait.jpg', word: 'GM',
    edit: 'Give him a big steaming white coffee mug held in both hands, eyes half closed and sleepy, eyes bleary. Add the word "GM" in huge bold black cartoon letters across the bottom',
    action: 'His WHOLE BODY sags and sways sleepily, head lolling forward then jerking back up, shoulders rising and falling with a huge yawn, torso rocking, shoulders swinging heavily. Then he lifts the mug with both arms and his whole body leans into the sip',
  },
  {
    ...
    action: 'He JUMPS — whole body leaving the ground, legs kicking, torso twisting, head thrown back, head and shoulders flying up, both fists punching the air, then lands in a squash and springs again. Full body jump, not just arms',
  },
  {
    ...
    action: 'His WHOLE BODY rears back then slams forward onto the button, torso folding, legs bracing, head snapping down with the hit, shoulders whipping forward, whole frame recoiling on impact, then rearing back to do it again',
  },
  {
    ...
    action: 'His WHOLE BODY leans hard into the camera, torso pushing forward, legs planting and sliding, head lowering, shoulders streaming backward from the force, whole frame shaking with the beams firing',
  },
  {
    ...
    action: 'His WHOLE BODY clenches around the candle, torso squeezing tighter, legs gripping, head shaking violently side to side in refusal, shoulders whipping, whole frame trembling with the effort',
  },
  {
    ...
    action: 'His WHOLE BODY rocks backward laughing, torso folding and unfolding, head tipping back then snapping forward to point again, shoulders heaving, legs unsteady, shoulders swinging with every laugh',
  },
  {
  ...
  },
  {
    ...
    action: 'His WHOLE BODY leans in impatiently then rocks back, hip cocking, foot tapping fast enough to shake his whole frame, head tilting and snapping to the camera, shoulders shrugging, shoulders bouncing',
  },
  {
    ...
    action: 'His WHOLE BODY rides upward with the candle, legs bending and straightening to absorb the surge, torso arching back, head thrown up, arms punching the sky, head and shoulders streaming down behind him in the wind',
  },
  {
    ...
    action: 'His WHOLE BODY rocks back in the chair laughing, torso heaving, legs kicking up and down, head tipping back, shoulders swinging, the chair rocking under him as cash sprays everywhere',
  },
  {
    ...
    action: 'His WHOLE BODY settles back into the throne with authority, torso reclining, shoulders rolling, head tilting up and giving a slow deliberate nod, cape and shoulders shifting with the movement, fingers steepling',
  },
  // --- the KEK pack -------------------------------------------------------
  ...
  },
  {
    ...
    edit: 'Show his whole body, eyes half closed and sleepy, eyes bleary, holding a big steaming white mug in both hands with a round green coin with a thick black outline and the word KEK in fat white rounded capital letters across the middle printed on the side of the mug. Add no text or lettering anywhere',
  ...
  // He works the fryer. It is the whole character, so it gets its own batch.
  {
    ...
    action: 'His WHOLE BODY dips down as he lowers the basket, knees bending, torso leaning forward over it, head dropping to watch, shoulders swinging forward — then he rises back up, chest lifting, head snapping up with a grin, the steam billowing and the fries jumping in the basket',
  },
  {
    ...
    action: 'His WHOLE BODY shakes the basket in tight fast bursts, arms juddering, shoulders and torso vibrating with it, legs braced and bouncing, head locked in place staring down, shoulders trembling, the flames flaring up higher with each shake',
  },
  {
    ...
    action: 'His WHOLE BODY sags and sways very slowly on the spot, shoulders slumping lower, head drooping forward then lolling back up, torso swaying, knees wobbling, shoulders hanging limp and swinging gently, the smoke curling upward, a single slow blink',
  },
  {
    ...
    action: 'His WHOLE BODY strides forward on the spot, legs pumping, torso twisting with each step, one arm whipping the cap away over his head and the other punching forward, head thrown back laughing, shoulders and apron strings flying behind him',
  },
  {
    ...
    action: 'His WHOLE BODY drives upward thrusting the carton higher, legs straightening onto his toes, torso stretching up, head thrown back to shout, shoulders flying, then dropping back down into a squash and driving up again, the green candles bouncing and springing in the carton',
  },
  {
