...
completely calm. Static wide shot, no camera move.` },
  ...
  video: [
    { id: 'v01-hero-low', treat: KEVIN_3D, duration: '5s',
      scene: `A real fast-food kitchen at night, stainless steel and oil haze, one strip light flickering. Low hero angle looking up at KEVIN standing square to camera, arms at his sides, steam rolling past the lens. The light pops once. Slow push in.` },
    { id: 'v02-rooftop-arms', treat: KEVIN_3D, duration: '5s',
      scene: `A real rooftop at night, a real lit city skyline behind, wind moving the air. KEVIN stands on the parapet with both arms raised wide, facing away over the city. Wide, camera slowly rising behind him.` },
    { id: 'v03-street-walk', treat: KEVIN_3D, duration: '5s',
      scene: `A real city street at night after rain, wet asphalt throwing back red and green neon, steam from a grate. KEVIN walks straight at camera in the centre of the lane, unhurried. Tracking backwards at his height, shallow focus.` },
    { id: 'v04-screens-green', treat: KEVIN_3D, duration: '5s',
      scene: `A real trading floor, a curved wall of monitors filled with rising green candlestick charts, cold blue room light. KEVIN stands small with his back to camera looking up at the wall. Wide, slow crane up.` },
    { id: 'v05-face-neon', treat: KEVIN_3D, duration: '5s',
      scene: `Extreme close on KEVIN's face, half lit by a buzzing red neon sign just off frame, the rest in shadow, rain on the air. He does not move. Locked off, very shallow depth of field.` },
    { id: 'v06-fryer-slowmo', treat: KEVIN_3D, duration: '5s',
      scene: `Macro slow motion on a real deep fryer basket dropping into hot oil, violent golden bubbles, oil droplets suspended, harsh kitchen light. No character in frame. Extreme close, 1000fps look.` },
    { id: 'v07-doorway', treat: KEVIN_3D, duration: '5s',
      scene: `A real service doorway at night seen from inside a dark corridor, hard white light blasting in from the street. KEVIN stands in the doorway as a silhouette, shoulders squared. Locked off, heavy backlight, dust in the beam.` },
    { id: 'v08-crowd-phones', treat: KEVIN_3D, duration: '5s',
      scene: `A real crowd at night, dozens of raised phones with their screens glowing, hands in the air, blurred bodies. KEVIN stands on a small stage riser in front of them, tiny, arms out. Wide, slight handheld.` },
    { id: 'v09-alley-run', treat: KEVIN_3D, duration: '5s',
      scene: `A real narrow alley at night, fire escapes, puddles, a single sodium lamp. KEVIN runs toward camera through the puddles, water kicking up. Tracking backwards fast, motion blur.` },
    { id: 'v10-car-window', treat: KEVIN_3D, duration: '5s',
      scene: `Inside a real car at night, rain on the glass, city lights streaking past outside, dashboard glow. KEVIN sits in the passenger seat looking out of the window. Close, handheld, shallow.` },
    { id: 'v11-speakers', treat: KEVIN_3D, duration: '5s',
      scene: `A real warehouse space, a stack of enormous PA speakers, dust in the air, one hard side light. KEVIN stands in front of the stack with his arms folded, the air visibly moving. Wide, slow dolly in.` },
    { id: 'v12-sparks', treat: KEVIN_3D, duration: '5s',
      scene: `A real industrial yard at night, an angle grinder throwing a shower of orange sparks across the frame in the background. KEVIN walks left to right through the foreground, completely unbothered. Side tracking shot.` },
    { id: 'v13-sign-flicker', treat: KEVIN_3D, duration: '5s',
      scene: `A real unbranded diner sign on a pole at night, red and white, buzzing and flickering against a black sky, moths in the light. No character. Locked off, slow zoom in.` },
    { id: 'v14-stairs-up', treat: KEVIN_3D, duration: '5s',
      scene: `A real concrete stairwell, green emergency lighting, graffiti-free walls, steep flights. KEVIN climbs toward camera from below, one step at a time. Looking straight down the stairwell, camera rising.` },
    { id: 'v15-kitchen-dance', treat: KEVIN_3D, duration: '5s',
      scene: `A real fast-food kitchen at night, stainless steel, steam. KEVIN bobs his head and moves his shoulders to a beat while working the fryer basket, loose and confident. Medium shot, slight handheld.` },
    { id: 'v16-rain-stand', treat: KEVIN_3D, duration: '5s',
      scene: `A real empty car park at night in heavy rain, one tall floodlight, puddles everywhere. KEVIN stands dead centre in the downpour, still, water bouncing off the ground around him. Wide, locked off.` },
    { id: 'v17-hands-tongs', treat: KEVIN_3D, duration: '5s',
      scene: `Close on a real stainless steel counter, steam rising, KEVIN's drawn hands setting down a pair of tongs deliberately. Only his hands and forearms in frame. Macro, shallow, hard top light.` },
    { id: 'v18-skyline-sit', treat: KEVIN_3D, duration: '5s',
      scene: `A real fire escape platform high on a building at night, a real city glittering below. KEVIN sits with his legs through the railing, looking out, the city breathing. Wide, still, slow drift.` },
  ],
  preview: [
